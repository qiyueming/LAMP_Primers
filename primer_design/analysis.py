...
"""
from ape import read_primerset_excel,APE
import pandas as pd
from mymodule import revcomp,LazyProperty
import primer3
from itertools import combinations_with_replacement
from collections import Counter,OrderedDict
from primer_design.config import CROSS_GENE_FILE,CROSS_GENE_NAME,\
        CROSS_GENE_NAME_LONG,REFape,REF,BAT,mv_conc,dv_conc,dntp_conc,\
        PrimerDimerTm,HairpindG,LoopHairpindG
...
global CROSS_GENE_SEQUENCE

def load_CROSS_GENE_SEQUENCE():
    global CROSS_GENE_SEQUENCE
